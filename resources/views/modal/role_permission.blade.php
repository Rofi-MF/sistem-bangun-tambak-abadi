<div class="modal-dialog">
    <div class="modal-content">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    @else
                        @foreach ($permissionActive as $row)
                            <tr class="odd gradeX">
                                <td>{{$row->name}}</td>
                                <td align="center"><input type="checkbox" class="input-small" id="rolePermissionRevoke"
                                                          value="{{$row->name}}"></td>
                            </tr>
                        @endforeach
                    @endif
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    @else
                        @foreach ($permissionNotActive as $raw)
                            <tr class="odd gradeX">
                                <td>{{$raw->name}}</td>
                                <td align="center"><input type="checkbox" class="input-small" id="rolePermissionGive"
                                                          value="{{$raw->name}}"></td>
                            </tr>
                        @endforeach
                    @endif
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" onclick="giveRolePermission()">Give</button>
            <button type="button" class="btn btn-danger" onclick="revokeRolePermission()">Revoke</button>
        </div>
    </div>
</div>
